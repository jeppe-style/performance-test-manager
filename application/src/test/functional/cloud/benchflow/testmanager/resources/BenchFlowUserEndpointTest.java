 ...
 *         created on 20.02.17.
 */
public class BenchFlowUserEndpointTest {
    ...
    public static final ResourceTestRule resources = ResourceTestRule.builder()
            ...
            .addResource(new BenchFlowUserResource(executorServiceMock, minioServiceMock, testModelDAOMock,
    ...
    public void runValidBenchFlowTest() throws Exception {
        ...
        Response response = resources.client()
                ...
                .path(BenchFlowUserResource.RUN_PATH)
